...
export default function Splash() {
  return (
    <div className="fixed inset-0 flex flex-col items-center justify-center bg-base overflow-hidden">
      ...
      >
        <div className="w-32 h-32 mb-6 rounded-full overflow-hidden shadow-2xl shadow-primary-blue/20 ring-1 ring-white/10">
          <img 
            src="https://res.cloudinary.com/dl285ghkr/image/upload/q_auto/f_auto/v1777876825/logo_mmgw3d.jpg" 
            alt="KrixenAI Logo" 
